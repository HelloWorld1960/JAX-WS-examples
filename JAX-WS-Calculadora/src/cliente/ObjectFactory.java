...
public class ObjectFactory {
    ...
    private final static QName _OperacionResponse_QNAME = new QName("http://ws/", "operacionResponse");
    private final static QName _Operacion_QNAME = new QName("http://ws/", "operacion");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws/", name = "operacionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws/", name = "operacion")
